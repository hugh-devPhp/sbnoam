...
<head>
    ...
    <title>gdj-ajout_award_lauréats</title>
    <?php
...
<body class="main">
            ...
            <div class="content">
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="overflow-x-auto">
                        <form method="post" id="add_laureate" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                                <div class="intro-y col-span-12 sm:col-span-4">
                                    ...
                                    <input id="input-wizard-4" type="text" required class="form-control" name="l_name" placeholder="Nom $ prénoms">
                                </div>
                                ...
                                <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                                    <input class="btn btn-primary w-24 ml-2" type="submit" value="Créer">
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        $("#add_laureate").submit(function(e) {
            e.preventDefault();
            var $this = $(this);
            var url = '<?php echo base_url('add_laureat'); ?>';
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response === true) {
                        ...
                        Swal.fire(
                            'Echèc!',
                            'lauréat non créé essayez à nouveau!',
                            'error'
                        )
                    } else {
