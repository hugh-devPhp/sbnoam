...
(1, '+225 07 78 70 17 73', '', 'shinebynoam@gmail.com', 'Côte d\'Ivoire, Abidjan, Port Bouet', '2024_04_26_18_10_29_1701873116.png', 'https://www.facebook.com/', '', '', '', '', 'Bienvenue chez SHYNE BY NOAM, votre destination en ligne pour des bijoux et accessoires uniques et inspirants. Nous nous engageons à créer des pièces magnifiques qui racontent des histoires et captivent votre imagination. Chez SHYNE BY NOAM, chaque bijou est méticuleusement conçu avec amour et soin, alliant artisanat traditionnel et style contemporain. Nos collections variées vous offrent un éventail de choix, des pièces délicates pour le quotidien aux créations audacieuses pour les occasions spéciales. Nous croyons en la beauté intemporelle des détails et nous nous efforçons d\'offrir à nos SHYNÉS des bijoux qui expriment votre individualité et votre élégance personnelle. Explorez notre sélection et laissez-vous inspirer par notre passion pour l\'art de la joaillerie. Découvrez votre prochain trésor chez SHYNE BY NOAM.');
