 ...
 * @original author	http://phpqrcode_lib.sourceforge.net/
 * 
 * @version		1.0
 */
...
{
	var $cacheable = true;
	var $cachedir = 'coeur/cache/';
	var $errorlog = 'http://localhost/membres_ecolemedia_2019/coeur/logs/';
	var $quality = true;
	var $size = 1024;
	
	function __construct($config = array()) {
		// call original library
		require_once(APPPATH."third_party/qrcode_lib/qrconst.php");
		require_once(APPPATH."third_party/qrcode_lib/qrtools.php");
		require_once(APPPATH."third_party/qrcode_lib/qrspec.php");
		require_once(APPPATH."third_party/qrcode_lib/qrimage.php");
		require_once(APPPATH."third_party/qrcode_lib/qrinput.php");
		require_once(APPPATH."third_party/qrcode_lib/qrbitstream.php");
		require_once(APPPATH."third_party/qrcode_lib/qrsplit.php");
		require_once(APPPATH."third_party/qrcode_lib/qrrscode.php");
		require_once(APPPATH."third_party/qrcode_lib/qrmask.php");
		require_once(APPPATH."third_party/qrcode_lib/qrencode.php");
