                    ...
                    <div class="bg-primary bg-soft">
                        <div class="row">
                            ...
                            <div class="col-5 align-self-end">
                                <img src="<?php echo base_url() ?>assets/admin/images/profile-img.png" alt=""
                                     class="img-fluid">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?php echo base_url() ?>assets/admin/images/users/avatar-1.jpg" alt=""
                                         class="img-thumbnail rounded-circle">
                                </div>
                                <h5 class="font-size-15 text-truncate"><?php echo $this->session->userdata('user_login') ?></h5>
                            ...
                            <div class="row col-span-12 sm:col-span-3">
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview"
                                             style="background-image: url('<?php echo base_url() ?>assets/admin/images/users/avatar-1.jpg')">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="first_name" id="firstname-input"
                                               value="<?php echo $this->session->userdata('name') ?>" placeholder="Nom">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="formrow-date-input" class="form-label">Date de naissance</label>
                                        <input type="date" class="form-control" name="birth" id="formrow-date-input"
                                               value="<?php echo $this->session->userdata('birth') ?>"
                                               placeholder="Nom">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="adresse" id="add-input"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="contacts" id="contact-input"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    <input type="password" class="form-control" required
                                           ...
                                           aria-label="Password" id="old_psd" name="old_psd"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    <input type="password" class="form-control" placeholder="Votre nouveau mot de passe"
                                           required aria-label="Password" id="new_psd" name="new_psd"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group auth-pass-inputgroup">
                                    <input type="password" class="form-control" placeholder="confirmez Mot de passe"
                                           required
                                           aria-label="Password" id="c_new_psd" name="c_new_psd"
