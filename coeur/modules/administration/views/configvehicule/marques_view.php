        ...
        <div class="card">
            <div class="card-body">
                ...
                <table id="datatable" class="table table-striped table-bordered dt-responsive  nowrap w-100">
                    ...
                    <tbody>
                    <?php if(isset($marques) && !empty($marques)){ $cpk=0;
                        foreach($marques as $row){
                            $cpk++;?>
                            <tr>
                                <td><?=$cpk;?></td>
                                <td style="text-transform: uppercase;"><?=$row['code_marque'];?></td>
                                <td style="text-transform: uppercase;"><?php if($row['activation_marque']==1) echo "Active"; else echo "Inactive";?></td>
                                <td>
                                    <div >
                                        <?php if(in_array('edit_statut_marque', is_inarray())) { ?>
                                            <a href="Javascript:void(0)"  class="blues" data-name="<?php echo $row['id_marque'];?>" data-act="<?php echo $row['activation_marque'];?>">
                                                <?php if($row['activation_marque']==1){?><button class="btn btn-warning waves-effect waves-light"><i class="bx bx-power-off font-size-16 align-middle "></i></button><?php } else {?><button class="btn btn-primary waves-effect waves-light"><i class="bx bxs-torch font-size-16 align-middle "></i></button><?php } ?></a>&nbsp;
                                        <?php }
                                        if(in_array('edit_marque', is_inarray())) { ?><a href="Javascript:void(0)" data-bs-toggle="modal" data-bs-target="#EditMyModal"class="green" data-name="<?php echo $row['id_marque'];?>" data-nom="<?php echo $row['code_marque']; ?>"  data-act="<?php echo $row['activation_marque'];?>" ><button class="btn btn-success waves-effect waves-light"><i class="bx bx-pencil font-size-16 align-middle "></i></button></a>&nbsp;
                                        <?php }
                                        if(in_array('delete_marque', is_inarray())) { ?>
                                            <a href="Javascript:void(0)"  class="red"  data-name="<?php echo $row['id_marque'];?>"><button class="btn btn-danger waves-effect waves-light"><i class="bx bx-trash font-size-16 align-middle"></i></button></a>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
