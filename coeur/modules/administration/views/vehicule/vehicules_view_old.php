                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8 col-sm-6">
                                <form class="mt-4 mt-sm-0 float-sm-end d-sm-flex align-items-center">
                                    ...
                                    <ul class="nav nav-pills product-view-nav justify-content-end mt-3 mt-sm-0">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#"><i class="bx bx-search-alt search-icon"></i></a>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-xl-4 col-sm-6 " >
                                <button class="btn btn-sm btn-primary" style="float: right !important;" type="button" id="add_car"><i class="bx bx-plus font-size-16 align-middle"></i>Ajouter</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="product-img position-relative">
                                            <div class="avatar-md product-ribbon">
                                                        <span class="avatar-title rounded-circle  bg-primary" style="background-color: #f67f00 !important;">
                                                            Location
                                                        </span>
                                            </div>
                                            <img src="<?php echo base_url()?>assets/admin/images/product/img-100.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">BMW Serie 1 </a></h5>

                                            <p class="text-muted">
                                                <i class="bx bx-sitemap"></i> Automatique &nbsp;
                                                <i class="bx bx-gas-pump"></i> Essence <br>
                                                <i class="bx bx-user"></i> 2 &nbsp;
                                                <i class="bx bxs-film"></i> 1 800km/h
                                            </p>
                                            <h5 class="my-0"><i class="bx bx-money text-muted"></i> <b>128 000Fcfa</b></h5>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="product-img position-relative">
                                            <div class="avatar-md product-ribbon">
                                                        <span class="avatar-title rounded-circle  bg-primary" style="background-color: #049e60 !important;">
                                                            Vente
                                                        </span>
                                            </div>
                                            <img src="<?php echo base_url()?>assets/admin/images/product/img-101.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Ford focus AT </a></h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="product-img position-relative">
                                            ...
                                            <img src="<?php echo base_url()?>assets/admin/images/product/img-102.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Suziki Alto </a></h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="product-img position-relative">
                                            ...
                                            <img src="<?php echo base_url()?>assets/admin/images/product/img-103.png" alt="" class="img-fluid mx-auto d-block">
                                        </div>
                                        <div class="mt-4 text-center">
                                            <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Peugeot 308 GT </a></h5>
...
<script>
    ...
    function DeleteForm(id){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("administration/configvehicule/delete_marque");?>",
            data: "delok=ok&id="+id,
            dataType: 'json', // JSON
            success: function(json){
                if(json.reponse=='1'){
