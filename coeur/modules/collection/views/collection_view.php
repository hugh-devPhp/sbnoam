                    ...
                    <div class="category-box-wrap">
                        ...
                        <div class="category-box-content">
                            <div class="content text-center">
                                <h3 class="title"><a href="<?php echo base_url() . "boutique/boutique_by_collection/" . $collection['id_collection']; ?>"><?php echo $collection['name']; ?></a></h3>
                                <a href="<?php echo base_url() . "boutique/boutique_by_collection/" . $collection['id_collection']; ?>" class="main-btn btn-filled">Voir details</a>
                            </div>
                        </div>
                    </div>
                </div>
