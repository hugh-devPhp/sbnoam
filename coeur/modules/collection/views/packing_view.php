                                ...
                                <div class="product-item__outer h-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="mb-1 product-item__title"><a href="<?php echo base_url('collection/detail_automobile/').$vehicule['id_auto'];?>" class="text-blue font-weight-bold">
                                            ...
                                            <div class="mb-2">
                                                <a href="<?php echo base_url('collection/detail_automobile/').$vehicule['id_auto'];?>" class="d-block text-center"><img class="img-fluid" style="height: 172.41px !important;" src="<?php echo base_url('uploads/vehicules/').$vehicule["image_principale_auto"]?>" alt="Image Description"></a>
                                            </div>
