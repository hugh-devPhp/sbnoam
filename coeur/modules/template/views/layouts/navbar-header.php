        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?php echo base_url() ?>assets/logo_pour_fonds_dorés.png" alt="" height="80">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo base_url() ?>assets/logo_pour_fonds_dorés.png" alt="" height="80">
                    </span>
                ...
                <a href="#" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?php echo base_url() ?>assets/logo_pour_fonds_dorés.png" alt="" height="50">
                    </span>
                    <span class="logo-lg">
                        <img src="<?php echo base_url() ?>assets/logo_pour_fonds_dorés.png" alt="" height="80">
                    </span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <div>
                                        <img src="<?php echo base_url(); ?>assets/admin/images/megamenu-img.png" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                        </div>
