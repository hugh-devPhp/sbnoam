<?php $this->load->view('template/front-end/haut_template', array("menu_actif" => $menu_actif)) ?>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="banner-content">
                        ...
                        <ul>
                            <li>
                                <a class="main-btn btn-filled wow fadeInUp" data-wow-delay=".7s" href="about.html">Buy Now </a>
                            </li>
                            <li>
                                <a class="main-btn btn-border wow fadeInUp" data-wow-delay=".9s" href="about.html">Explore Now</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="apartment-box">
                        <div class="image-box">
                            <a href="shop-detail.html" class="d-block">
                                <img src="assets/img/list-suite/01.jpg" alt="img">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="apartment-box">
                        <div class="image-box">
                            <a href="shop-detail.html" class="d-block">
                                <img src="assets/img/list-suite/02.jpg" alt="img">
                            </a>
                        </div>
                        <div class="content-box-2">
                            <h3 class="title">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="apartment-box">
                        <div class="image-box">
                            <a href="shop-detail.html" class="d-block">
                                <img src="assets/img/list-suite/03.jpg" alt="img">
                            </a>
                        </div>
                        <div class="content-box-2">
                            <h3 class="title">
    ...
    <section class="items-overlay-sec">
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                <div class="col-lg-3 col-md-6">
                    <div class="condo-item" style="background-image: url(assets/img/items/menu-gallery-1.jpg);">
                        <div class="title">
                            <i class="fal fa-plus text-white"></i>
                            <h4 class="text-white">Handmade Earring</h4>
                        </div>
                        <div class="title title-hidden">
                            <h4 class="text-white mt-0">Handmade Earring</h4>
                            <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do</p>
                            <div class="book-btn">
                                <a href="shop-detail.html"><i class="fal fa-long-arrow-right"></i>Buy now</a>
                            </div>
                        </div>
                        <a href="shop-detail.html" class="main-btn btn-border">Starting at $299</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="condo-item" style="background-image: url(assets/img/items/menu-gallery-2.jpg);">
                        <div class="title">
                            <i class="fal fa-plus text-white"></i>
                            <h4 class="text-white">Diamond Nosering</h4>
                        </div>
                        <div class="title title-hidden">
                            <h4 class="text-white mt-0">Diamond Nosering</h4>
                            <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do</p>
                            <div class="book-btn">
                                <a href="shop-detail.html"><i class="fal fa-long-arrow-right"></i> Buy now </a>
                            </div>
                        </div>
                        <a href="shop-detail.html" class="main-btn btn-border">Starting at $499</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="condo-item" style="background-image: url(assets/img/items/menu-gallery-3.jpg);">
                        <div class="title">
                            <i class="fal fa-plus text-white"></i>
                            <h4 class="text-white">Silver Bracelet</h4>
                        </div>
                        <div class="title title-hidden">
                            <h4 class="text-white mt-0">Silver Bracelet</h4>
                            <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do</p>
                            <div class="book-btn">
                                <a href="shop-detail.html"><i class="fal fa-long-arrow-right"></i> Book now</a>
                            </div>
                        </div>
                        <a href="shop-detail.html" class="main-btn btn-border">Starting at $299</a>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="condo-item" style="background-image: url(assets/img/items/menu-gallery-4.jpg);">
                        <div class="title">
                            <i class="fal fa-plus text-white"></i>
                            <h4 class="text-white">Gold Pendents</h4>
                        </div>
                        <div class="title title-hidden">
                            <h4 class="text-white mt-0"> Gold Pendents</h4>
                            <p class="text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do</p>
                            <div class="book-btn">
                                <a href="shop-detail.html"><i class="fal fa-long-arrow-right"></i>Book now </a>
                            </div>
                        </div>
                        <a href="shop-detail.html" class="main-btn btn-border">Starting at $199</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--====== CORE FEATURES START ======-->
    <section class="pt-115 pb-115 bg-white" style="background-image: url('assets/img/others/product.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="block-text">
                        ...
                        <p class="pr-50">
                            ...
                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, aliquip ex ea commodo consequat you have to understand this.
                        </p>
                ...
                <div class="px-2 w-100">
                    <div class="row wide-shop-post-slider mt-80">
                        ...
                        <div class="col-12">
                            <div class="food-box shop-box">
                                <div class="thumb">
                                    <img src="assets/img/shop/04.jpg" alt="images">
                                    <div class="badges">
                                        <span class="price">Sale</span>
                                ...
                                <div class="desc">
                                    <h4>
                                        <a href="shop-detail.html">Moon Necklace</a>
                                    </h4>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="food-box shop-box">
                                ...
                                <div class="desc">
                                    <h4>
                                        <a href="shop-detail.html">Diamond Ring.</a>
                                    </h4>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="food-box shop-box">
                                ...
                                <div class="desc">
                                    ...
                                    <span class="price">$580 <span>$630</span></span>
                                    <a href="shop-detail.html" class="link"><i class="fal fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="food-box shop-box">
                                <div class="thumb">
                                    ...
                                    <div class="badges">
                                        <span class="price">Sale</span>
                                        <span class="price discounted">-40%</span>
                                    </div>
                                    <div class="button-group">
                                        <a href="#"><i class="far fa-heart"></i></a>
                                        <a href="#"><i class="far fa-sync-alt"></i></a>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="food-box shop-box">
                                ...
                                <div class="desc">
                                    ...
                                    <span class="price">$800 <span>$920</span></span>
                                    <a href="shop-detail.html" class="link"><i class="fal fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <!--====== SHOP PART END ======-->
    <!--====== SERVICE PART START ======-->
    <section class="service-sec bg-black pt-115 pb-85">
        <div class="container">
    ...
    <section class="pt-115 pb-115 bg-white list-type-section style-2">
        <div class="container">
            <div class="section-title text-center mb-50">
                <div class="section-title-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs" version="1.1" width="45" height="45" x="0" y="0" viewBox="0 0 512 512" xml:space="preserve" class="">
            ...
            <div class="row list-items">
                <div class="col-lg-6">
                    <div class="list-box extra-height">
                        <div class="list-bg" style="background-image: url(assets/img/list-type/03.jpg);">
                        </div>
                        <div class="list-content">
                            <h3><a href="shop-detail.html">Ariel Ring</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur elit, sed do eiusmod tempor incididunt ut labore magna aliqua.</p>
                        </div>
                        <a href="shop-detail.html" class="list-link"><i class="fal fa-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12 col-md-6">
                            <div class="list-box">
                                <div class="list-bg" style="background-image: url(assets/img/list-type/01.jpg);">
                                </div>
                                <div class="list-content">
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="list-box">
                                <div class="list-bg" style="background-image: url(assets/img/list-type/02.jpg);">
                                </div>
                                <div class="list-content">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10 order-2 order-lg-1">
                    <div class="block-text">
                        <div class="section-title mb-20">
                            <span class="title-tag">design video</span>
                        ...
                        <a href="contact.html" class="main-btn btn-filled mt-40">See More</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-10 order-1 order-lg-2 wow fadeInRight" data-wow-delay=".3s">
                    <div class="video-wrap video-wrap-two mb-small" style="background-image: url(assets/img/text-block/03.jpg);">
    ...
    <section class="pt-115 pb-115 blog-style-2">
        <div class="container">
            ...
            <div class="row no-gutters latest-post-slider mt-80">
                <div class="col-lg-12">
                    <article class="blog-post" style="background-image: url('assets/img/blog/blog-1.png');">
                        <div class="blog-data">
                            <div class="post-date">
                                26 Jun, 2022
                            </div>
                ...
                <div class="col-lg-12">
                    <article class="blog-post" style="background-image: url('assets/img/blog/blog-2.png');">
                        <div class="blog-data">
                            <div class="post-date">
                                26 Jun, 2022
                            </div>
                ...
                <div class="col-lg-12">
                    <article class="blog-post" style="background-image: url('assets/img/blog/blog-3.png');">
                        <div class="blog-data">
                            <div class="post-date">
                                26 Jun, 2022
                            </div>
                ...
                <div class="col-lg-12">
                    <article class="blog-post" style="background-image: url('assets/img/blog/blog-4.png');">
                        <div class="blog-data">
                            <div class="post-date">
                                26 Jun, 2022
                            </div>
