...
<div class="container mt-5">
    ...
    <?php endif; ?>
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin_blog/save'); ?>">
        ...
        <a href="<?php echo base_url('admin_blog'); ?>" class="btn btn-secondary">Annuler</a>
    </form>
</div>
</body>
</html> 